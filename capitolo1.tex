...
In questa sezione indagheremo le prime proprietà del'entropia e dimostreremo i primi risultati che getteranno le basi per le costruzioni successive
...
\end{oss}
Può essere interessante capire come si comporta l'entropia nel caso le variabili in considerazione siano dipendenti, per fare ciò definiremo l'\textit{entropia condizionata}.\\
Alla definizione di \textit{entropia condizionata} premettiamo una nota sulla notazione:\\
