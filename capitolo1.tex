...
\item presa $Y$ variabile casuale allora $U(X,Y)=U_X(Y)+U(X)$ dove $U_X(Y)= \sumj p_j U(Y|X=j)$ dove $(Y|X=j)$ può essere vista come una variabile casuale di legge di probabilità  $\{ p_j(1)...p_j(m) \}$ 
\end{enumerate}
\end{defi}
