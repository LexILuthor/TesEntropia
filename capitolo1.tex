...
Può essere interessante capire come si comporta l'entropia nel caso in cui le variabili in considerazione siano dipendenti, per fare ciò definiremo l'\textit{entropia condizionata}. Alla definizione premettiamo una precisazione sulla notazione.\\
...
Per siano $X$ e $Y$ due variabili casuali rispettivamente  \lep e  $\{q_1...q_n \}$
\begin{enumerate}
